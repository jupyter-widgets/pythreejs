...
# -*- coding: utf-8 -*-
#
# pythreejs documentation build configuration file, created by
...
project = 'pythreejs'
copyright = '2017, PyThreejs Development Team'
...
_version_py = os.path.join(repo, 'pythreejs', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pythreejsdoc'
...
latex_documents = [
    (master_doc, 'pythreejs.tex', 'pythreejs Documentation',
     'PyThreejs Development Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'pythreejs', 'pythreejs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pythreejs', 'pythreejs Documentation',
     author, 'pythreejs', 'One line description of project.',
     'Miscellaneous'),
]
